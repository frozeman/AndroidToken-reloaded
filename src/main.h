...
static const int64 MAX_MONEY = 100000000000 * COIN; // 100 billion
static const int64 MAX_MINT_PROOF_OF_WORK = 66800000000 * COIN; // PREMINE in the first block
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY_PPC = 50;
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 30; // 30s block spacing 
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 5; // minimum age for coin age 5d
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 15; // stake age of full weight 15d
...
public:
    ...
    {
        // androidtoken: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // androidtoken: get transaction coin age
...
public:
    ...
    // androidtoken: block signature - signed by coin base txout[0]'s owner
    ...
    // androidtoken: entropy bit for stake modifier if chosen by modifier
    ...
    // androidtoken: two types of block: proof-of-work or proof-of-stake
    ...
    // androidtoken: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // androidtoken: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // androidtoken: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // androidtoken: block index flags
    enum  
    {
