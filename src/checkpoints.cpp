...
namespace Checkpoints
{
    ...
    // androidtoken: synchronized checkpoint (centrally broadcasted)
    ...
    // androidtoken: get last synchronized checkpoint
    ...
    // androidtoken: only descendant of current sync-checkpoint is allowed
    ...
    // androidtoken: reset synchronized checkpoint to last hardened checkpoint
...
// androidtoken: sync-checkpoint master key
...
// androidtoken: verify signature of sync-checkpoint message
...
// androidtoken: process synchronized checkpoint
