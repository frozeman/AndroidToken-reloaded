        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start AndroidToken on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start AndroidToken after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the AndroidToken client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show AndroidToken addresses in the transaction list"));
